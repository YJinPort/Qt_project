...
/* 파일 전송시 여러번 나눠서 전송 */
void ChattingForm_Client::goOnSend(qint64 numBytes) // Start sending file content
{
...
/* 파일 보내기 */
void ChattingForm_Client::sendFile() // Open the file and get the file name (including path)
{
    loadSize = 0;
    byteToWrite = 0;
    totalSize = 0;
